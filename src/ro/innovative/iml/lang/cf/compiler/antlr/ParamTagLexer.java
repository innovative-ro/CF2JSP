// $ANTLR : "ParamTag.g" -> "ParamTagLexer.java"$
...
public class ParamTagLexer extends antlr.CharScanner implements ParamTagParserTokenTypes, TokenStream
 {
public ParamTagLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public ParamTagLexer(Reader in) {
	this(new CharBuffer(in));
}
public ParamTagLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public ParamTagLexer(LexerSharedInputState state) {
	super(state);
